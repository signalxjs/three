...
[GitHub Discussions](https://github.com/signalxjs/three/discussions). It keeps
...
- [Report a bug](https://github.com/signalxjs/three/issues/new?template=bug_report.yml)
- [Request a feature](https://github.com/signalxjs/three/issues/new?template=feature_request.yml)

Before filing, please:

- Check existing [issues](https://github.com/signalxjs/three/issues?q=is%3Aissue) and
  [discussions](https://github.com/signalxjs/three/discussions) to avoid duplicates.
